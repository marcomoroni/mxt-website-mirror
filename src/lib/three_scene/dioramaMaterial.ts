...
export function newDioramaMaterial(ambientOcclusionTextureAndHighlight: string) {
	const material = new THREE.ShaderMaterial({
        ...
        void main() {
            ...
            // Add 'highlightColorWithDim' to 'baseColor'. The 'highlightColorWithDim' should be faded when at the edge of the diorama.
            ...
            vec3 baseColorWithHighlight = mix(baseColor, highlightColorWithDim, uvTex.g * higlightColorAmount);

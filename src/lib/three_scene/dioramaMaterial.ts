...
export function newDioramaMaterial(ambientOcclusionTextureAndHighlight: string) {
	const material = new THREE.ShaderMaterial({
        ...
        uniform vec3 highlightColorDim;
        ...
        void main() {
            ...
            vec3 highlightColorWithDim = mix(highlightColor, highlightColorDim, accentColorDimVisibility);
            ...
            // Add 'highlightColorWithDim' to 'baseColor_'. The 'highlightColorWithDim' should be faded when at the edge of the diorama.
            ...
            vec3 baseColorWithHighlight = mix(baseColor_, highlightColorWithDim, uvTex.g * higlightColorAmount);
		...
		uniforms: {
			...
			highlightColorDim: { value: new THREE.Color('blue') },
	...
	return {
		...
		setHighlightColorDim: (value: THREE.Color) => {
			material.uniforms.highlightColorDim.value = value;
		},
		dispose: () => {
			material.dispose();
		}

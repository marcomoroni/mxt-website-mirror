...
<Content {caseStudies} relatedCaseStudies={['stonehenge']}>
	<div class="grid">
			...
			<Card intro={true}>
				<div slot="front" class="intro">
					<p>
						...
						transform your existing data into intuitive simulations for diverse stakeholders ranging
						from members of the public and policy makers to designers, engineers and operational
						teams.
					</p>
				</div>
			</Card>
		...
		<div class="card-container-3 common-card-min-height">
			<Card backgroundImg={'/images/CountessJ_Sequence01.0000_colours.jpeg'}>
				<svelte:fragment slot="front">
					<CardContentScaffold width="1">
						...
						<ColumnsCardContent.Container>
							...
							<ColumnsCardContent.Column>
								...
								<p>
									...
									show those customers how their journeys will change.
								</p>
								<p>
